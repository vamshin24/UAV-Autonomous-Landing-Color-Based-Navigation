#ifndef __7BUPJmiZWohjxdnHoE998C_h__
#define __7BUPJmiZWohjxdnHoE998C_h__
...
#ifndef struct_tag_AKDTi3UGp6avKSe1GXakaE
#define struct_tag_AKDTi3UGp6avKSe1GXakaE

struct tag_AKDTi3UGp6avKSe1GXakaE
{
  int32_T isInitialized;
  boolean_T TunablePropsChanged;
};

#endif                                 /* struct_tag_AKDTi3UGp6avKSe1GXakaE */

#ifndef typedef_parrot_TCPReceive
#define typedef_parrot_TCPReceive

typedef struct tag_AKDTi3UGp6avKSe1GXakaE parrot_TCPReceive;
...
typedef struct tag_L5JvjW1A13FyCQi5N783sB cell_wrap;

#endif                                 /* typedef_cell_wrap */

#ifndef struct_tag_FfLrxQ8rLS43NgaCulDHrC
#define struct_tag_FfLrxQ8rLS43NgaCulDHrC

struct tag_FfLrxQ8rLS43NgaCulDHrC
{
  char_T f1[8];
  char_T f2[6];
  char_T f3[6];
...
#endif                                 /* struct_tag_FfLrxQ8rLS43NgaCulDHrC */

#ifndef typedef_cell
#define typedef_cell

typedef struct tag_FfLrxQ8rLS43NgaCulDHrC cell;

#endif                                 /* typedef_cell */

#ifndef struct_tag_SlLPSk64DVMGrdPVu4PBTC
#define struct_tag_SlLPSk64DVMGrdPVu4PBTC

struct tag_SlLPSk64DVMGrdPVu4PBTC
{
  char_T f1[8];
  char_T f2[6];
  char_T f3[6];
...
#endif                                 /* struct_tag_SlLPSk64DVMGrdPVu4PBTC */

#ifndef typedef_b_cell
#define typedef_b_cell

typedef struct tag_SlLPSk64DVMGrdPVu4PBTC b_cell;

#endif                                 /* typedef_b_cell */

#ifndef struct_tag_vIxMQjXJOYq5MLLGOluw7G
#define struct_tag_vIxMQjXJOYq5MLLGOluw7G

struct tag_vIxMQjXJOYq5MLLGOluw7G
{
  char_T f1[8];
  char_T f2[6];
  char_T f3[6];
...
#endif                                 /* struct_tag_vIxMQjXJOYq5MLLGOluw7G */

#ifndef typedef_c_cell
#define typedef_c_cell

typedef struct tag_vIxMQjXJOYq5MLLGOluw7G c_cell;
...
typedef struct tag_Hm6EPE5ncyWd4RGCxxctzF d_cell;
...
typedef struct tag_n5V6NPhGd1s3l2q7z9eOR e_cell;
...
typedef struct tag_VqK0uXiUXuliBvHmvcLR0F f_cell;
...
typedef struct tag_6jR4RtbHdjyG00WYqgD5nF b_cell_wrap;
...
typedef struct tag_njgfiHhWBCqqqpWsKZxr7F g_cell;
...
#ifndef struct_tag_URrQOsuFgHezvr1Uq6EBbB
#define struct_tag_URrQOsuFgHezvr1Uq6EBbB

struct tag_URrQOsuFgHezvr1Uq6EBbB
{
  cell _data;
};

#endif                                 /* struct_tag_URrQOsuFgHezvr1Uq6EBbB */

#ifndef typedef_s_URrQOsuFgHezvr1Uq6EBbB
#define typedef_s_URrQOsuFgHezvr1Uq6EBbB

typedef struct tag_URrQOsuFgHezvr1Uq6EBbB s_URrQOsuFgHezvr1Uq6EBbB;

#endif                                 /* typedef_s_URrQOsuFgHezvr1Uq6EBbB */

#ifndef struct_tag_kU24v4OMepcurHsnH0HZqF
#define struct_tag_kU24v4OMepcurHsnH0HZqF

struct tag_kU24v4OMepcurHsnH0HZqF
{
  b_cell _data;
};

#endif                                 /* struct_tag_kU24v4OMepcurHsnH0HZqF */

#ifndef typedef_s_kU24v4OMepcurHsnH0HZqF
#define typedef_s_kU24v4OMepcurHsnH0HZqF

typedef struct tag_kU24v4OMepcurHsnH0HZqF s_kU24v4OMepcurHsnH0HZqF;

#endif                                 /* typedef_s_kU24v4OMepcurHsnH0HZqF */

#ifndef struct_tag_WJHXwIU51Z4rMAyriMq1vE
#define struct_tag_WJHXwIU51Z4rMAyriMq1vE

struct tag_WJHXwIU51Z4rMAyriMq1vE
{
  c_cell _data;
};

#endif                                 /* struct_tag_WJHXwIU51Z4rMAyriMq1vE */

#ifndef typedef_s_WJHXwIU51Z4rMAyriMq1vE
#define typedef_s_WJHXwIU51Z4rMAyriMq1vE

typedef struct tag_WJHXwIU51Z4rMAyriMq1vE s_WJHXwIU51Z4rMAyriMq1vE;

#endif                                 /* typedef_s_WJHXwIU51Z4rMAyriMq1vE */
...
#ifndef typedef_InstanceStruct_7BUPJmiZWohjxdnHoE998C
#define typedef_InstanceStruct_7BUPJmiZWohjxdnHoE998C
...
#endif                                 /* typedef_InstanceStruct_7BUPJmiZWohjxdnHoE998C */
...
extern void method_dispatcher_7BUPJmiZWohjxdnHoE998C(SimStruct *S, int_T method,
  void* data);
